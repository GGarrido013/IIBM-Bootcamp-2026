...
\begin{document}
	...
	\begin{flushleft}\small
		\large{\textbf{IIBM BootCamp 2026 \href{https://github.com/GGarrido013/IIBM-Bootcamp-2026}{GitHub}}}\\
		\textbf{Instructors: } Jorge González (\href{mailto:jfgonzalez5@uc.cl}{jfgonzalez5@uc.cl}) \& Gabriel Garrido (\href{mailto:gagarrido@uc.cl}{gagarrido@uc.cl})
...
\begin{center}
\LARGE\textbf{IIBM Bootcamp 2026}\\
\end{center}
...
%\end{center}
%----------------------------------------------------------------------------------------
Location: Classroom \textbf{C404}, located in the 4th floor of Civil Construction
\Large
...
\hline
10:30 \ 12:30 & Intro to Variable Types  & Speaker: \textbf{Tomás Egaña}*  & Matlab Introduction  & Speaker: \textbf{Pablo Irarrázaval}* & Matlab Images  \\
\hline
